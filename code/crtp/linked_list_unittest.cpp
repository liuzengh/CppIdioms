...
void ExpectListContentsForDirection(const LinkedList<Node>& list, int num_nodes,
                                    const int* node_ids, bool forward) {
  int i = 0;
...
void ExpectListContents(const LinkedList<Node>& list, int num_nodes,
                        const int* node_ids) {
  {
